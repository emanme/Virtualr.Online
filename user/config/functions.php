...
function linkl($link="",$content="") {
$link = "<a href='$link'>".ufirst($content)."</a>";
  return $link;
}
function error_404() {
...
function stringCut($string,$start,$numberofchar,$dot=false)
{
  if($dot){
    return substr($string, $start, $numberofchar)."...";
  }else{
    return substr($string, $start, $numberofchar);
  }
